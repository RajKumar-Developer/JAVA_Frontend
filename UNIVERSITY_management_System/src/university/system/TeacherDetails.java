...
public class TeacherDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"Name","Father's Name","Age","Date of Birth","Address","Phone","Email","Class X(%)", "Class XII(%)", "Aadhar No","Course","Employee ID", "Department"};
...
//            DefaultTableModel model1=(DefaultTableModel) .getModel();
