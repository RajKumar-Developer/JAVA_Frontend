...
class UpdateTeacher implements ActionListener{
    ...
    public boolean check(){
        ...
        if(t13.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(f,"Enter Department");
            return false;
        }
        return true;
    }
    ...
    private void bActionPerformed(ActionEvent evt) {
        if(check()) {
            try {
                ...
                String str = "update teacher set name='" + t1.getText() + "',fathers_name='" + t2.getText() + "',age='" + t3.getText() + "', dob='" + t4.getText() + "',address='" + t5.getText() + "',phone='" + t6.getText() + "',email='" + t7.getText() + "',class_x='" + t8.getText() + "',class_xii='" + t9.getText() + "',aadhar='" + t10.getText() + "',course='" + t13.getText() +"', emp_id = '" + t11.getText() +  "',dep='" + t14.getText() + "' where emp_id='" + t12.getText() + "'";
    ...
    private void b2ActionPerformed(ActionEvent evt) {
        try{
            ...
            ResultSet rs = st.executeQuery("select * from teacher where emp_id = '"+t12.getText()+"'");
            if(rs.next()){
                f.setVisible(true);
                ...
                t11.setText(rs.getString("emp_id"));
                t13.setText(rs.getString("course"));
                t14.setText(rs.getString("dep"));
            }
        }catch(Exception ex){}
    }
