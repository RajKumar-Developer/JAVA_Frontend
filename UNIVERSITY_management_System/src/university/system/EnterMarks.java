...
public class EnterMarks extends JFrame implements ActionListener{
    ...
    public void b1ActionPerformed(ActionEvent ae){
        try{
            ...
            PreparedStatement pst = (PreparedStatement) cc.prepareStatement(s1);
            PreparedStatement pst1 = (PreparedStatement) cc.prepareStatement(s2);
            pst.executeUpdate();
            pst1.executeUpdate();
